...
const Enquiry = ({ setPopup }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-md bg-opacity-50 z-[1000]"> {/* Added z-[1000] */}
      <div
        data-aos="fade-up"
      ...
      >
        ...
        <h1 className="text-xl text-blue-600 font-semibold text-center mb-4">
          Enquiry Form
        </h1>
        <form
          ref={EnquiryRef}
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-orange-600 text-white py-2 rounded hover:bg-white hover:text-orange-600 hover:border hover:border-orange-600 font-semibold transition duration-300"
          >
            Send Message
          </button>
        </form>
