...
const calculatePricing = ({ baseAmount, journalAmount = 0, addonsAmount = 0, participantCategory, hasMembership, hasCoupon }) => {
  ...
  // Discounted base + journal + addons + membership fee
...
const CheckoutPanel = ({
  ...
  return (
    <div className="md:w-[420px] shrink-0 space-y-4">
        ...
        <div className="flex items-start justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-7 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${
              membership ? "bg-blue-600" : "bg-gray-300"
            }`}
            style={{ width: "52px" }}
      ...
      {/* Coupon Card */}
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5 shadow-sm">
        <h3 className="text-[15px] font-bold text-blue-600 mb-1">
        ...
        {couponStatus === "valid" ? (
          ...
          <div className="flex gap-2 mt-2">
            <input
              ...
              className="flex-1 border border-blue-300 bg-white rounded-xl px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
            />
            <button
              type="button"
  ...
  return (
    <section>
      <Hero
        ...
        backgroundImage="/images/commonheroimages/commonhero11.webp"
      />
      <section className="pt-10 md:pt-2">
        ...
        <div data-aos="fade-up" className="flex flex-col justify-center items-center text-center my-5 space-y-4">
          ...
          <p className="w-11/12 font-medium">
            Welcome to the ICAEBMS-2026 registration page. Secure your spot at this premier
            conference to connect with global experts, present your research and advance your career.
          ...
          <div data-aos="fade-up" className="grid grid-cols-1 md:grid-cols-2 gap-4 md:p-5 w-full">
            {participationFees1.map((fee, index) => (
              <table key={index} className="table-auto w-full border-collapse rounded-b-md shadow-xl">
                <caption className="bg-gradient-to-t from-blue-800 to-blue-700 text-white p-2 rounded-t-md font-bold text-md">
                  {fee.title}
                </caption>
                <thead>
                    ...
                    <tr key={i} className={`${i % 2 === 0 ? "bg-gray-100" : "bg-white"} text-sm font-[450]`}>
                      ...
                      <td className="border-r border-gray-200 p-4">
                        <label className="text-gray-500 line-through">
                          <input disabled type="radio" name="price"
        ...
        <div data-aos="fade-up" className="flex flex-col justify-center items-center mt-10 p-5 md:py-0">
          ...
          <p className="text-md font-medium mt-2 text-center">
            "1<span className="text-sm align-super">st</span> International Conference on Applied
            Science, Engineering, Education, Business, Management and Social Science &amp; Humanities
            (ICAEBMS-2026)"
          </p>
          ...
          >
            ...
            <div className="mt-6 md:mt-0 w-full md:w-auto">
              ...
              <div className="mt-4 space-y-3">
                ...
                <button type="submit"
                  className="w-full py-3.5 bg-gradient-to-r from-blue-700 to-blue-600 text-white font-bold text-base rounded-2xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-md hover:shadow-lg">
                  Check Out
                </button>
