...
function DiscountConfetti() {
  return (
    <div><div className="md:rounded-xl md:p-6 md:mx-10 md:mt-12 bg-gradient-to-r from-green-800 to-emerald-900  p-5 h-60 md:h-46 ">
        <ConfettiCanvas>
          <div className="text-center flex flex-col justify-center items-center space-y-6">
            ...
            <div className="flex flex-row justify-between items-center space-x-6">
              <a
                data-aos="zoom-out"
                className="py-2 px-4 bg-yellow-500 hover:bg-white transition duration-500 text-emerald-700 rounded font-semibold"
                target="_blank"
              ...
              <a
                data-aos="zoom-out"
                className="py-2 px-4 bg-yellow-500 hover:bg-white text-emerald-700 transition duration-500 rounded font-semibold"
                target="_blank"
