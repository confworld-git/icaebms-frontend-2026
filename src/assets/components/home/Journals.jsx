  ...
  return (
    <div className="min-h-screen bg-blue-100 flex flex-col items-center justify-center p-8 ">
      ...
      <div className="max-w-6xl w-full mb-8">
        ...
        <p className="text-lg text-gray-800 text-center mb-">
      ...
      <div className="max-w-6xl w-full relative">
        {/* Card */}
        <div className="bg-whitere rounded-2xl shadow-2xl p-12 min-h-[400px] flex flex-col justify-center transition-all duration-500">
          <div className="space-y-4">
            <div className="text-blue-700 text-md font-semibold tracking-wide">
              {publications[currentIndex].type}
            </div>
            <h3 className="text-xl md:text-3xl font-bold text-blue-900 leading-tight">
              {publications[currentIndex].title}
            </h3>
            <div className="text-blue-800 text-lg">
              {publications[currentIndex].authors}
            </div>
            <div className="text-blue-700 italic pt-4">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 text-blue-800 p-4 transition-all hover:scale-110"
        ...
        <button
          onClick={nextSlide}
          className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 text-blue-800 p-4 transition-all hover:scale-110"
      ...
      <div className="max-w-6xl w-full mt-8 text-center">
        <p className="text-2xl text-gray-800 font-semibold">
          Join us at ICAEBMS and unlock the opportunity to publish your research in reputed <br/>Scopus / SCIE indexed journals.
        </p>
      </div>
    </div>
  );
